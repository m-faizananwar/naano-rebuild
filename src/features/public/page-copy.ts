...
export const FOR_CREATORS = {
  hero: {
    ...
    logosHeading: "The brands already on Naano",
  },
  monetize: {
    ...
    network: { caption: "Get sponsored by our network", logos: ["lemlist", "gojiberry", "ringover", "folk.", "ChatSEO", "naano"] },
    ownDeal: { title: "A deal you sourced", site: "yourbrand.com", amount: "€2,000", bonusLabel: "Naano bonus", bonus: "+ €300", note: "Contract & payout handled. You just close it.", caption: "Bring your own deals & earn extra" },
  ...
  platform: {
    ...
    dashboard: {
      ...
      rows: [
        ...
        { company: "Naano", tag: "SaaS", status: "Active", amount: "€51.70" },
  ...
  faq: {
    ...
    items: [
      { q: "What is Naano?", a: "Naano is the B2B LinkedIn creator marketplace: B2B brands book creators for sponsored LinkedIn posts at a fixed price per post that you set. Creators from about 1,000 to 500,000 followers use Naano to monetize their LinkedIn audience with deals from B2B brands they already know." },
      { q: "Is Naano free for creators?", a: "Yes. Joining is free and there is no monthly fee. You set a net price per post; the brand pays that price through the platform and you receive it in full." },
      { q: "How much can I earn?", a: "You set your own rate per post. The marketplace floor is €20 and the platform limit is €1,500 per post; typical rates sit between €300 and €1,500 depending on your audience, and creators earn around €500 per deal on average. Naano recommends a starting price from your public audience data when you build your card." },
      { q: "How and when do I get paid?", a: "Naano pays you within 24 hours of your post going live, by instant transfer or SEPA through Stripe Connect. Contracts and invoices are handled for you." },
      ...
      { q: "What kind of brands are on Naano?", a: "B2B software and services companies: SaaS, AI, sales tech, marketing tools, fintech, HR tech and more, mostly in Europe and North America. Brands like lemlist, Attio, folk, ringover and La Growth Machine run campaigns on Naano." },
...
export const FOR_AGENCIES = {
  hero: {
    eyebrow: "Naano for agencies",
    title: "Choose the workspace that matches your agency.",
    sub: "Naano separates brand operations from creator management. Choose your setup and create the right workspace for your agency.",
  ...
  call: {
    ...
    note: "30 minutes with the Naano team. No commitment.",
  },
...
export const PRICING_PAGE = {
  hero: {
    ...
    sub: "Choose whether you want to run creator campaigns in-house or have Naano operate them. Campaign spend is always separate from the plan.",
  },
  perPost: {
...
export const CASE_STUDY_PAGE = {
  ...
  sub: "After one €2,000 sponsored post returned just three sign-ups, BlogSEO rebuilt creator marketing on Naano, and turned it into predictable, trackable pipeline.",
  tags: "B2B SaaS · SEO",
  ...
  sections: [
    {
      n: "01",
      title: "The challenge",
      lead: "Before Naano, BlogSEO had already tested influencer marketing. They paid €2,000 for a single sponsored post and generated only three sign-ups.",
    ...
    },
    {
      n: "02",
      title: "The campaign",
      lead: "BlogSEO launched a LinkedIn creator campaign with Naano, matched with ~10 relevant creators and a €5,000 budget.",
      body: ["Over the campaign, creators published around 15 posts designed to reach BlogSEO's target audience and generate qualified demand. Every post was tracked through Naano, so the team could see which creators and which content generated real commercial intent."],
      post: { title: "Creator campaign post", sub: "Tracked in Naano · LinkedIn", text: "\"I fired my SEO agency. An AI agent now runs it.\", one of the creator posts that drove qualified demand for BlogSEO." },
    },
    {
      n: "03",
      title: "The results",
  ...
  why: {
    n: "04",
    title: "Why it worked",
    sub: "The difference wasn't spending more on creators. Naano made the campaign operational.",
    bullets: [
  ...
  quote: {
    text: "Naano became one of our fastest acquisition channels. We know exactly what every creator brings.",
