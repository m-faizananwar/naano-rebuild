  ...
  return (
    <GlassSection className="section-ink px-4 py-24 sm:px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <GlassCard title={CASE_STUDY.brand} index={1} className="mt-10 p-4 sm:p-8" bodyClassName="grid gap-6 lg:grid-cols-[2fr_3fr]">
          <div className="rounded-2xl bg-card/80 p-5 shadow-lg ring-1 ring-border/60">
          ...
          <div className="rounded-2xl bg-card/80 p-6 shadow-sm ring-1 ring-border/60 sm:p-8">
