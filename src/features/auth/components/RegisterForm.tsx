...
const COPY: Record<Role, { title: string; sub: string }> = {
  ...
  creator: { title: "Join Naano", sub: "Get paid to create LinkedIn content for B2B brands you actually use." },
};
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-5" noValidate>
      <div>
        ...
        <h1 className="mt-4 text-3xl font-semibold tracking-tight">{COPY[role].title}</h1>
        <p className="mt-1 font-semibold text-brand">Creators. Brands. Results.</p>
