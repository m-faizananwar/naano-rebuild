      ...
      <div className="grid gap-4">
        <div className="grid gap-4 lg:grid-cols-2">
          <section className="rounded-2xl border bg-background p-5">
            <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Naano creators on Slack</p>
            ...
            <ul className="mt-4 grid gap-1 text-sm">
              ...
              <li>✓ Talk directly with the Naano team</li>
            </ul>
          ...
          <section className="rounded-2xl border bg-background p-5">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Add your creator card to LinkedIn so brands can discover your work and join Naano through your attributed link.</p>
            <p className="mt-4 rounded-xl bg-brand/5 p-3 text-sm">
              <span className="text-2xl font-semibold">{AFFILIATE_SHARE_PERCENT}%</span> of Naano&apos;s commission for {AFFILIATE_MONTHS} months — leave your card on your LinkedIn profile; if a brand joins Naano through it, your reward is tracked automatically.
            </p>
