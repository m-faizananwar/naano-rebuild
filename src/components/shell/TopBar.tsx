...
import {
  DropdownMenu, DropdownMenuContent, DropdownMenuGroup, DropdownMenuLabel, DropdownMenuTrigger,
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-72">
            <DropdownMenuGroup>
              ...
              <p className="px-2 pb-2 text-sm text-muted-foreground">Nothing new. Invitations, drafts and payments will show up here.</p>
            </DropdownMenuGroup>
          </DropdownMenuContent>
        </DropdownMenu>
